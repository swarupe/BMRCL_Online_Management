...
create table CUSTOMER(Cust_Id int primary key,Address varchar(20),Phone_No varchar(10),Fname varchar(10),Lname varchar(10),Password varchar(10),Username varchar(10));
